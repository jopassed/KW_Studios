...
function studio_scripts() {
    ...
    wp_enqueue_style( 'slick', get_template_directory_uri() .'/slick/slick.css', '1.0.1' );

    wp_enqueue_style( 'slick-theme', get_template_directory_uri() .'/slick/slick-theme.css', '1.0.1' );
